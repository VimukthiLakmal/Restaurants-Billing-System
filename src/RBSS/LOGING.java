...
public class LOGING extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("RESTURENT BILLING SYSTEM 1.0");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       try{
           ...
           String query = "select* from loging where username = '"+username+"' AND password = '"+password+"'";
           ...
           JOptionPane.showMessageDialog(rootPane, "INVALID LOGING");
           }
